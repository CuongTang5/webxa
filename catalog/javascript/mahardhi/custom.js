	...
	function responsiveheader(){
		if (prevWidth != $(window).width()) {
			if ($(window).width() <= 991) {	
				...
				$(".vertical-category-wrapper").css("display","none");
				$(".catgory-left .vertical-category-wrapper").css("display","block");
			}
			else{
				$('.vertical-category').appendTo('.vertical-category-wrapper');
				$(".vertical-category-wrapper").css("display","block");
				$(".catgory-left .vertical-category-wrapper").css("display","none");
			}
